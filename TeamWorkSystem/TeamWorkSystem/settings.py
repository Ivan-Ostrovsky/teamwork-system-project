"""
Django settings for TeamWorkSystem project.
...
prv = PrivateConfig('TeamWorkSystem/private.json')
...
ROOT_URLCONF = 'TeamWorkSystem.urls'
...
WSGI_APPLICATION = 'TeamWorkSystem.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER' : prv.get('DATABASE', 'USER'), # укажите пользователя
        'PASSWORD' : prv.get('DATABASE', 'PASSWORD'), # укажите пароль базы данных (входа пользователя)
        'NAME': prv.get('DATABASE', 'NAME'), # укажите наименование базы данных
    }
}
